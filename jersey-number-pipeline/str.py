...
from str.parseq.strhub.data.module import SceneTextDataModule
from str.parseq.strhub.models.utils import load_from_checkpoint, parse_model_args
...
def main():
    ...
    #kwargs.update({'weights_only': True})
    kwargs.update({'strict': False})
    torch.serialization.add_safe_globals([getattr])
    torch.serialization.add_safe_globals([torch.optim.swa_utils.SWALR])
